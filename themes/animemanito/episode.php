...
?>
<?php startZone(); ?>
<title><?php echo $data['serie']['name'] . ' ' . $data['episode']['number'] . ' Sub Español - ' . $config['site_name']; ?></title>
<!-- Seo -->
...
<meta name="title" content="<?php echo htmlspecialchars('Ver ' . $data['serie']['name'] . ' ' . $data['episode']['number'] . ' Online Sub Español'); ?>" />
<meta name="description" content="<?php echo htmlspecialchars('Ver ' . $data['serie']['name'] . ' ' . $data['episode']['number'] . ', descargar ' . $data['serie']['name'] . ' ' . $data['episode']['number'] . ' hd, watch ' . $data['serie']['name'] . ' ' . $data['episode']['number'] . ''); ?>" />
<meta name="keywords" content="<?php echo htmlspecialchars($data['serie']['name'] . ' ' . $data['episode']['number'] . ', ver ' . $data['serie']['name'] . ' ' . $data['episode']['number'] . ', descargar ' . $data['serie']['name'] . ' ' . $data['episode']['number'] . ''); ?>" />
<meta property="og:title" content="<?php echo htmlspecialchars('Ver ' . $data['serie']['name'] . ' ' . $data['episode']['number'] . ': Japones-Subtitulado Online Sub Español'); ?>" />
<meta property="og:description" content="<?php echo htmlspecialchars($data['serie']['name'] . ' ' . $data['episode']['number'] . ', ver ' . $data['serie']['name'] . ' ' . $data['episode']['number'] . ', descargar ' . $data['serie']['name'] . ' ' . $data['episode']['number'] . ' hd, watch ' . $data['serie']['name'] . ' ' . $data['episode']['number'] . ''); ?>" />
            ...
            <div class="columns is-multiline">
                ...
                <div class="column is-12-mobile is-8-tablet is-9-desktop">
                    ...
                    <h1 class="title is-size-4 has-text-centeredX has-text-weight-semibold is-uppercaseX has-text-light">
                        <?php echo $data['serie']['name']; ?> <?php if(isset($data['episode']['episodegroup'])) {echo $data['episode']['episodegroup'];} else { echo $data['episode']['number'];} ?> Sub Español
                    </h1>
