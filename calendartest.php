...
<body>
  ...
  <div class="row">
    <?php
    $animeSinFecha = array(); // Array para almacenar anime sin fecha de estreno
    ...
    <?php foreach ($wintergrouped as $date => $list) { ?>
      ...
      <?php } else { ?>
        ...
        $animeSinFecha = array_merge($animeSinFecha, $list);
    ...
    $animeSinFechaChunks = array_chunk($animeSinFecha, 10);

    // Mostrar los grupos de elementos sin fecha de estreno al final
    foreach ($animeSinFechaChunks as $chunkIndex => $chunk) { ?>
      <div class="children">
        <div class="img-container">
